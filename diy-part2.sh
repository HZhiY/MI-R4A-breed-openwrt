...
sed -i '/uci commit system/i\uci set system.@system[0].hostname='HZYDB'' package/lean/default-settings/files/zzz-default-settings
...
sed -i "s/OpenWrt /HZY/g" package/lean/default-settings/files/zzz-default-settings
